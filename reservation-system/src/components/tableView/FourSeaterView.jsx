...
import { FourSeaterAvai, FourSeaterTaken } from "../FourSeater";
  ...
  return (
    <Popover>
      <PopoverTrigger onClick={() => getTableAttributes()}>
        {availability === false ? <FourSeaterAvai /> : <FourSeaterTaken />}
      </PopoverTrigger>
      <PopoverContent>
